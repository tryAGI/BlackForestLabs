...
## Features 🔥
- Fully generated C# SDK based on [official BlackForestLabs OpenAPI specification](https://api.bfl.ai/openapi.json) using [AutoSDK](https://github.com/HavenDV/AutoSDK)
