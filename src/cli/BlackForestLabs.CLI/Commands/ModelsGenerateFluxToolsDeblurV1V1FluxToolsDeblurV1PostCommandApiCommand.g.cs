...
internal static partial class ModelsGenerateFluxToolsDeblurV1V1FluxToolsDeblurV1PostCommandApiCommand
{
    ...
    {
        var command = new Command(@"generate-flux-tools-deblur-v1-v1-flux-tools-deblur-v1-post", @"Remove blur from an image
Submits a deblur task. The input image is regenerated by a FLUX blur-removal model to sharpen it while preserving the original scene, objects, composition, and lighting. No prompt needed.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::BlackForestLabs.Flux2DeblurInputs>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Models.GenerateFluxToolsDeblurV1V1FluxToolsDeblurV1PostAsync(
                                    image: image,
                                    seed: seed,
