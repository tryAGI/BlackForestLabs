...
internal static partial class ModelsGenerateFluxToolsEraseV1V1FluxToolsEraseV1PostCommandApiCommand
{
    ...
    private static Option<string> Mask { get; } = new(
        name: @"--mask")
    {
        Description = @"Base64-encoded black/white mask. White pixels indicate the object to remove; black pixels are preserved. Must have the same dimensions as the input image.",
        Required = true,
    };
