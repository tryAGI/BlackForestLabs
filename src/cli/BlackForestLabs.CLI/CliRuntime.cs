...
namespace BlackForestLabs.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "BlackForestLabs.CLI";
    private const string UserSecretApiKeyName = "BLACKFORESTLABS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BLACKFORESTLABS_API_KEY"];
    private const string CredentialFileDirectoryName = ".black-forest-labs";

    public static async global::System.Threading.Tasks.Task<global::BlackForestLabs.BlackForestLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::BlackForestLabs.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::BlackForestLabs.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::BlackForestLabs.BlackForestLabsClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::BlackForestLabs.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::BlackForestLabs.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::BlackForestLabs.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::BlackForestLabs.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BLACKFORESTLABS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::BlackForestLabs.ApiException exception)
    {
        var builder = new StringBuilder();
