...
namespace BlackForestLabs
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::BlackForestLabs.EndPointSecurityRequirement s_GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostSecurityRequirement0 =
        ...
        private static readonly global::BlackForestLabs.EndPointSecurityRequirement[] s_GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostSecurityRequirements =
            new global::BlackForestLabs.EndPointSecurityRequirement[]
            {                s_GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostSecurityRequirement0,
            };
        partial void PrepareGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::BlackForestLabs.Flux3VideoVE2VNamedInputs request);
        partial void PrepareGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::BlackForestLabs.Flux3VideoVE2VNamedInputs request);
        partial void ProcessGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlackForestLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlackForestLabs.AutoSDKHttpResponse<global::BlackForestLabs.AnyOf<global::BlackForestLabs.AsyncResponse, global::BlackForestLabs.AsyncWebhookResponse>>> GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostArguments(
            ...
            var __authorizations = global::BlackForestLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostSecurityRequirements,
                operationName: "GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::BlackForestLabs.PathBuilder(
                                path: "/v1/flux-tools/video-edit-v1",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlackForestLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlackForestLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1Post",
                                methodName: "GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostAsync",
                                pathTemplate: "\"/v1/flux-tools/video-edit-v1\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlackForestLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateFluxToolsVideoEditV1V1FluxToolsVideoEditV1PostAsync(
                request: __request,
                requestOptions: requestOptions,
